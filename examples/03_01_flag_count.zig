//! Port of https://github.com/clap-rs/clap/blob/master/examples/tutorial_builder/03_01_flag_count.rs
...
pub fn cli(a: std.mem.Allocator) clap.Command {
    return clap.Command.init(a, "03_01_flag_count")
        .about(harness.pkg_about)
        .version(harness.pkg_version)
        .arg(clap.Arg.new("verbose").short('v').long("verbose").action(.count));
}
