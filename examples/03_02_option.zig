//! Port of https://github.com/clap-rs/clap/blob/master/examples/tutorial_builder/03_02_option.rs
...
pub fn cli(a: std.mem.Allocator) clap.Command {
    return clap.Command.init(a, "03_02_option")
...
pub fn run(a: std.mem.Allocator, argv: []const []const u8, out: *std.ArrayList(u8)) u8 {
    ...
    harness.print(a, out, "name: {s}\n", .{harness.optOr(m.getOne([]const u8, "name"), "(none)")});
    return 0;
}
