//! Port of https://github.com/clap-rs/clap/blob/master/examples/tutorial_builder/04_01_enum.rs
...
pub fn cli(a: std.mem.Allocator) clap.Command {
    return clap.Command.init(a, "04_01_enum")
...
pub fn run(a: std.mem.Allocator, argv: []const []const u8, out: *std.ArrayList(u8)) u8 {
    ...
    if (std.mem.eql(u8, m.getOne([]const u8, "MODE").?, "fast")) {
