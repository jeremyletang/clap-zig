...
pub const entries = [_]Entry{
    ...
    // ----- action.rs (blocked: nearly all assert argument indices index_of/indices_of) -----
    .{ .file = "action.rs", .name = "set", .status = .deferred, .note = "argument indices + args_override_self" },
    .{ .file = "action.rs", .name = "append", .status = .deferred, .note = "argument indices (indices_of)" },
    .{ .file = "action.rs", .name = "set_true", .status = .deferred, .note = "argument indices + args_override_self" },
    .{ .file = "action.rs", .name = "set_true_with_explicit_default_value", .status = .deferred, .note = "argument indices" },
    ...
    .{ .file = "action.rs", .name = "set_false", .status = .deferred, .note = "SetFalse default + argument indices" },
    .{ .file = "action.rs", .name = "set_false_with_explicit_default_value", .status = .deferred, .note = "argument indices" },
    ...
    .{ .file = "action.rs", .name = "count", .status = .deferred, .note = "argument indices" },
    .{ .file = "action.rs", .name = "count_with_explicit_default_value", .status = .deferred, .note = "count default_value + argument indices" },
