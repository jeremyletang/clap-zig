...
pub const entries = [_]Entry{
    ...
    .{ .file = "possible_values.rs", .name = "ignore_case_multiple", .status = .deferred, .note = "multi-value options (num_args>1)" },
    .{ .file = "possible_values.rs", .name = "ignore_case_multiple_fail", .status = .deferred, .note = "multi-value options (num_args>1)" },
    ...
    .{ .file = "indices.rs", .name = "indices_mult_opts", .status = .deferred, .note = "multi-value options (num_args>1)" },
    .{ .file = "indices.rs", .name = "index_mult_opts", .status = .deferred, .note = "multi-value options (num_args>1)" },
    .{ .file = "indices.rs", .name = "indices_mult_opt_value_delim_eq", .status = .deferred, .note = "value_delimiter" },
    .{ .file = "indices.rs", .name = "indices_mult_opt_value_no_delim_eq", .status = .deferred, .note = "multi-value options (num_args>1)" },
